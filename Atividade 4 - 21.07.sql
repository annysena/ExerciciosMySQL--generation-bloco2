...
insert into tb_produto (nome, quantidade, valor, peso, categoria_id) values ("Maça em kg", 40, 13.90, 1.2, 1);
insert into tb_produto (nome, quantidade, valor, peso, categoria_id) values ("Laranja em kg", 48, 10.90, 2.5, 1);
insert into tb_produto (nome, quantidade, valor, peso, categoria_id) values ("Couve em gramas", 19, 2.99, 100, 2);
insert into tb_produto (nome, quantidade, valor, peso, categoria_id) values ("Bróculis em gramas", 12, 15.40, 500, 2);
insert into tb_produto (nome, quantidade, valor, peso, categoria_id) values ("Abóbora em kg", 6, 9.90, 3.2, 3);
insert into tb_produto (nome, quantidade, valor, peso, categoria_id) values ("Berinjela em gramas", 17, 4.90, 250, 3);
insert into tb_produto (nome, quantidade, valor, peso, categoria_id) values ("Chia em gramas", 10, 1.99, 0.80, 4);
insert into tb_produto (nome, quantidade, valor, peso, categoria_id) values ("Farinha de Mandioca em gramas", 35, 6.30, 790, 5);
